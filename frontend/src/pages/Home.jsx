                    ...
                    <div className="flex flex-1 flex-col md:flex-row md:items-center justify-between gap-4 w-full">
                        <div>
                            ...
                            <p className="text-sky-50 text-sm leading-relaxed max-w-2xl">
                                ...
                                <br />
                                <br />
                                O projeto resolve o problema da dispersão de informações, oferecendo aos professores e, principalmente, aos alunos uma interface <strong>unificada e simples</strong> onde é possível conhecer as atuais <strong> linhas de pesquisa</strong>, encontrar <strong>orientadores cujas publicações estejam alinhadas aos seus interesses de produção acadêmica</strong>.
                                <br />
                                <br />
                                Além disso, é possível também explorar <strong>redes de colaboração</strong> entre professores, acompanhar suas produções científicas e seu <strong>impacto</strong>, e, ainda, ter acesso a <strong>recursos úteis</strong> para produção de artigos e TCCs.
                            </p>
                        </div>
